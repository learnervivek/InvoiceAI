    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-white">
            ...
            <div className="hidden lg:flex relative bg-slate-950 flex-col justify-between p-12 text-white overflow-hidden">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_20%,#1e3a8a_0%,transparent_50%)] opactiy-50" />
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_80%,#1e1b4b_0%,transparent_50%)] opacity-50" />
                ...
                <div className="relative z-10">
                    ...
                    >
                        <h1 className="text-5xl font-bold leading-tight">
                            The future of <br />
                            <span className="text-blue-400">intelligent invoicing</span>
                        </h1>
                        <p className="text-lg text-slate-400 leading-relaxed">
                            Join thousands of businesses using InvoiceAI to transform their billing process through the power of conversational AI.
                        </p>
                    </motion.div>
                </div>
                ...
                <div className="relative z-10 grid grid-cols-2 gap-8">
                    <div className="space-y-2">
                        ...
                        <p className="text-sm text-slate-500">Just chat to generate complex invoices instantly.</p>
                    </div>
                    <div className="space-y-2">
                        <div className="flex items-center gap-2 text-blue-400">
                        ...
                        <p className="text-sm text-slate-500">Enterprise-grade encryption for all your financial data.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="w-full max-w-[440px] space-y-8">
                    ...
                    <div className="lg:hidden flex justify-center mb-8">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-2xl font-bold text-slate-950">InvoiceAI</span>
                        </div>
                    </div>
